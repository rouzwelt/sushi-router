...
import { TRIDENT_STABLE_POOL_FACTORY_ADDRESS } from '../src/config/index.js'
import {
  Amount,
  Price,
  Token,
...
import { computeTridentStablePoolAddress } from '../src/pool/trident-stable/compute-trident-stable-pool-address.js'
import { TridentStablePool } from '../src/pool/trident-stable/trident-stable-pool.js'
