...
import { TridentConstantPoolFactoryChainId, TridentStablePoolFactoryChainId } from '../trident-sdk';
...
export declare class TridentProvider extends LiquidityProvider {
    ...
    constructor(chainId: Extract<ChainId, BentoBoxV1ChainId & TridentConstantPoolFactoryChainId & TridentStablePoolFactoryChainId>, web3Client: PublicClient, databaseClient?: PrismaClient);
