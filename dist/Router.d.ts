...
export declare class Router {
    ...
    static routeProcessor3Params(poolCodesMap: Map<string, PoolCode>, route: MultiRoute, fromToken: Type, toToken: Type, to: Address, RPAddr: Address, permits?: PermitData[], maxPriceImpact?: number, source?: RouterLiquiditySource): RPParams;
