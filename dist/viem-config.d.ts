...
export { arbitrum, avalanche, bsc, celo, fantom, mainnet, optimism, polygon } from 'viem/chains';
...
declare const config: Record<number, PublicClientConfig>;
export { arbitrumNova, boba, bobaAvax, bobaBnb, bttc, config, fuse, gnosis, harmony, heco, kava, metis, moonbeam, moonriver, okex, palm, polygonZkEvm };
