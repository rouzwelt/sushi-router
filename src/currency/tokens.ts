...
export const axlUSDT: Record<keyof typeof axlUSDT_ADDRESS, Token> = addressMapToTokenMap(
  {
    decimals: 6,
    symbol: "axlUSDT",
...
export const axlDAI: Record<keyof typeof axlDAI_ADDRESS, Token> = addressMapToTokenMap(
  {
    decimals: 18,
    symbol: "axlDAI",
...
export const axlETH: Record<keyof typeof axlETH_ADDRESS, Token> = addressMapToTokenMap(
  {
    decimals: 18,
    symbol: "axlETH",
...
export const axlWBTC: Record<keyof typeof axlWBTC_ADDRESS, Token> = addressMapToTokenMap(
  {
    decimals: 8,
    symbol: "axlWBTC",
...
export const USD_PLUS: Record<keyof typeof USD_PLUS_ADDRESS, Token> = addressMapToTokenMap(
  {
    decimals: 6,
    symbol: "USD+",
    name: "USD+",
