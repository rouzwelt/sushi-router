...
export class DataFetcher {
  ...
  // PrismaClient | undefined = undefined
  ...
  async fetchPoolsForToken(currency0: Type, currency1: Type, excludePools?: Set<string>, options?: {blockNumber?: bigint}): Promise<void> {
