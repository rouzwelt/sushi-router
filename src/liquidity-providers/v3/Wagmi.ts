...
export class WagmiProvider extends UniswapV3BaseProvider {
  constructor(chainId: ChainId, web3Client: PublicClient) {
    ...
    const initCodeHash = {
      [ChainId.ETHEREUM]: "0x30146866f3a846fe3c636beb2756dbd24cf321bc52c9113c837c21f47470dfeb",
      ...
      [ChainId.ZKSYNC_ERA]: "0x30146866f3a846fe3c636beb2756dbd24cf321bc52c9113c837c21f47470dfeb",
      [ChainId.METIS]: "0x30146866f3a846fe3c636beb2756dbd24cf321bc52c9113c837c21f47470dfeb",
    } as const;
    const tickLens = {
