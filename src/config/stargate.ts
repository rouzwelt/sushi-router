...
export const STARGATE_POOL_ADDRESS: Record<number, Record<string, string>> = {
  ...
  [ChainId.FANTOM]: {
    [STARGATE_USDC_ADDRESS[ChainId.FANTOM]]: "0xc647ce76ec30033aa319d472ae9f4462068f2ad7",
  },
  [ChainId.METIS]: {
    [STARGATE_USDT_ADDRESS[ChainId.METIS]]: "0x2b60473a7C41Deb80EDdaafD5560e963440eb632",
  },
  [ChainId.BASE]: {
  ...
  [ChainId.LINEA]: {
    [STARGATE_ETH_ADDRESS[ChainId.LINEA]]: "0xAad094F6A75A14417d39f04E690fC216f080A41a",
  },
};
