...
import { PoolType, RPool, RToken, TYPICAL_MINIMAL_LIQUIDITY, TYPICAL_SWAP_GAS_COST } from "./RPool";
  ...
  calcOutByIn(
    ...
    while (input > 0) {
      ...
      if (startFlag) {
        ...
        const nextTickPriceBI = getSqrtRatioAtTick((this.ticks[nextTickToCross] as CLTick).index);
